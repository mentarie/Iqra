...
public class LatihanBacaActivity_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_latihan_baca_6);
        ...
        button_before = findViewById(R.id.j1_h6_b);
        ...
        button_next = findViewById(R.id.j1_h6_n);
        ...
        //1
        k_j1_h6 = findViewById(R.id.k_j1_h6);
        k_j1_h6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_1, k_j1_h6);
            }
        });

        //2
        baca_j1_h6_2 = findViewById(R.id.baca_j1_h6_2);
        baca_j1_h6_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_2, baca_j1_h6_2);
            }
        });

        //3
        baca_j1_h6_3 = findViewById(R.id.baca_j1_h6_3);
        baca_j1_h6_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_3, baca_j1_h6_3);
            }
        });

        //4
        baca_j1_h6_4 = findViewById(R.id.baca_j1_h6_4);
        baca_j1_h6_4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_4, baca_j1_h6_4);
            }
        });

        //5
        baca_j1_h6_5 = findViewById(R.id.baca_j1_h6_5);
        baca_j1_h6_5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_5, baca_j1_h6_5);
            }
        });

        //6
        baca_j1_h6_6 = findViewById(R.id.baca_j1_h6_6);
        baca_j1_h6_6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_6, baca_j1_h6_6);
            }
        });

        //7
        baca_j1_h6_7 = findViewById(R.id.baca_j1_h6_7);
        baca_j1_h6_7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_7, baca_j1_h6_7);
            }
        });

        //8
        baca_j1_h6_8 = findViewById(R.id.baca_j1_h6_8);
        baca_j1_h6_8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_8, baca_j1_h6_8);
            }
        });

        //9
        baca_j1_h6_9 = findViewById(R.id.baca_j1_h6_9);
        baca_j1_h6_9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_9, baca_j1_h6_9);
            }
        });

        //10
        baca_j1_h6_10 = findViewById(R.id.baca_j1_h6_10);
        baca_j1_h6_10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_10, baca_j1_h6_10);
            }
        });

        //11
        baca_j1_h6_11 = findViewById(R.id.baca_j1_h6_11);
        baca_j1_h6_11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                playAudio(R.raw.mp_baca_j1_h6_11, baca_j1_h6_11);
            }
        });

        //12
        baca_j1_h6_12 = findViewById(R.id.baca_j1_h6_12);
        baca_j1_h6_12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
